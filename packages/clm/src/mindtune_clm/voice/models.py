    ...
    def to_audio_asset(
        ...
        return AudioAsset(
            ...
            provenance=[
                ...
                f"source_curriculum_item_id={self.provenance.get('source_curriculum_item_id', '')}",
                f"curriculum_item_ids={','.join(self.provenance.get('curriculum_item_ids', []))}",
                f"morphology_source_ids={','.join(self.provenance.get('morphology_source_ids', []))}",
                f"pointing_source={','.join(self.provenance.get('pointing_source', []))}",
                f"help_references={','.join(self.provenance.get('help_references', []))}",
                f"linguistic_validation_status={self.provenance.get('linguistic_validation_status', '')}",
                f"curriculum_status={self.provenance.get('curriculum_status', '')}",
                f"validation_checksum={self.provenance.get('validation_checksum', '')}",
            ],
