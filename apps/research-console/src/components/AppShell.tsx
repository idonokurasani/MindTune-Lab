...
const TABS: { id: Tab; label: string }[] = [
  ...
  { id: 'calibration-overview', label: 'Calibration' },
  { id: 'calibration-session', label: 'Cal Session' },
  { id: 'calibration-profile-review', label: 'Profile Review' },
  { id: 'hebrew', label: 'Hebrew' },
  { id: 'curriculum', label: 'Curriculum' },
  { id: 'learner-progression', label: 'Learner Progression' },
  { id: 'item-inspection', label: 'Item Inspection' },
